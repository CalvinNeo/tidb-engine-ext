...
impl<E: Engine, L: LockManager, F: KvFormat> Storage<E, L, F> {
    ...
    /// delete operations will be through a special channel (unimplemented yet).
    ...
    /// `start_key` and goes backwards. If `end_key` is `None`, it
    /// means unbounded.
    ///
    ...
    pub fn raw_checksum(
        ...
        // TODO: Modify this method in another PR for backup & restore feature of Api
        // V2.
