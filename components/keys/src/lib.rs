...
pub const SNAPSHOT_CHANGE_SET_SUFFIX: u8 = 0x05;
pub const REGION_INNER_KEYOFF_SUFFIX: u8 = 0x06;
...
pub fn snapshot_change_set_key(region_id: u64) -> [u8; 11] {
    make_region_prefix(region_id, SNAPSHOT_CHANGE_SET_SUFFIX)
}

pub fn region_inner_key_off_key(region_id: u64) -> [u8; 11] {
    make_region_prefix(region_id, REGION_INNER_KEYOFF_SUFFIX)
}

pub fn region_encryption_key_key(region_id: u64) -> [u8; 11] {
    make_region_prefix(region_id, REGION_ENCRYPTION_KEY_SUFFIX)
}
